...
import { Button, Typography, Box, TableContainer, Table, TableBody, TableRow, TableCell } from "@mui/material";
        ...
        <Box sx={{px:'15%'}}>
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Box component='img' src={otherData['image']} sx={{height:'300px', width:'200px'}}/>
